            ...
            <div className="capPlot">
              {/* Display Capacity Plot if there is more than 1 data point and it is Windows */}
              {
                ...
                <div className="capacityPlot">
                  ...
                  <ResponsiveContainer width="100%" minHeight={600}>
                    <LineChart data={this.props.capPlotData} margin={{ top: 50, right: 20, bottom: 100, left: 0 }}>
              ...
              {/* Display Capacity Plot if there is more than 1 data point and it is Mac or Hardware test */}
              {
                ...
                <div className="capacityPlot">
                  ...
                  <ResponsiveContainer width="100%" minHeight={600}>
                    <LineChart data={this.props.capPlotData} margin={{ top: 0, right: 20, bottom: 20, left: 0 }}>
            ...
            <div className="dcPlot">
              {/* Display Discharging Plot if there is available data */}
              {
                ...
                <div className="dischargingPlot">
                  ...
                  <ResponsiveContainer width="100%" minHeight={600}>
                    <LineChart data={this.props.dcPlotData} margin={{ top: 100, right: 20, bottom: 20, left: 0 }}>
                      ...
                      <Line name= "Discharging Current" strokeDasharray="3 3" yAxisId="current" dot={true} type="linear" dataKey="discharging_current" stroke="#82ca9d" strokeWidth= {4} height={50}>
